...
from app.Microchip.pde import Pde
...
parser.add_argument('--l1',
    ...
    help="up and down distance")

parser.add_argument('--l2',
    default = 0.15, type=float,
    help="left and right distance")

parser.add_argument('--h',
    default = 0.00, type=float,
    help="increasing distance, default is 0.05")
...
parser.add_argument('--show_figure',
                    default='True', type=str,
                    help='Whether to show figure in Gmsh, default is False')
...
bm.get_current_backend()
import matplotlib.pyplot as plt

fig = plt.figure()
axes = fig.gca()
mesh.add_plot(axes)
mesh.find_node(axes, showindex=True, fontsize=2)
plt.show()
