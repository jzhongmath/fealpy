...
class DLDMicrofluidicChipLFEMModel3D(ComputationalModel):
    """
    ...
    def set_init_mesher(self, mesher: DLDMicrofluidicChipMesher3D):
        """
    ...
    def linear_system(self):
        ...
        self.mesh.number_of_global_ipoints(2)
