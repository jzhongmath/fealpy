...
from ..geometry import DLDMicrofluidicChipModeler3D


class DLDMicrofluidicChipMesher3D:
    """
    A mesher class for generating finite element meshes for DLD microfluidic 3D chip.
    ...
    def __init__(self, options: Optional[dict] = None):
        """
        Initialize the DLD microfluidic 3D chip mesher.
    ...
    def generate(self, modeler: DLDMicrofluidicChipModeler3D, gmsh: Any = None) -> None:
        """
    ...
    def build_mesh(self, gmsh: Any) -> TriangleMesh:
        ...
        return TetrahedronMesh(node[unique], new_cell)
